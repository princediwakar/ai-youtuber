...
export function detectLayoutType(contentData: any): LayoutType {
    ...
    if (contentData.format_type && layouts[contentData.format_type as LayoutType]) {
        ...
        if (layoutType !== 'mcq' && layoutType !== 'quick_tip') {
             console.log(`✅ Detected layout via format_type key: ${layoutType}`);
             return layoutType;
        }
    }
    ...
    if (hasQuickTipStructure) {
        console.log(`✅ Detected quick_tip layout structure.`);
        return 'quick_tip';
    }
    ...
    if (hasMCQStructure) {
        console.log(`✅ Detected MCQ layout structure - using proven format.`);
        return 'mcq';
    }
...
export function createRenderFunctions(
    ...
    console.log(`✅ Using render functions for layout: ${finalLayoutType}`);
